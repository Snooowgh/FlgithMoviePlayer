...
public class BallGame extends Application {
	private static String VIEW_GAME = "/exampleCode/resources/GameView.fxml";
	private static String STYLESHEET_FILE = "/exampleCode/resources/style.css";
	public static Image ICON = new Image(BallGame.class.getResourceAsStream("/exampleCode/resources/head.png"));
